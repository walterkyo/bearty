<%@ Page Language="C#" Culture="en-US" AutoEventWireup="true" CodeFile="profile_cn.aspx.cs" Inherits="profile_cn" Debug="true" %>
...
<script>    (function (d, s, id) {
    ...
    <div class="wrapper">
	    <div class="header">
            ...
            <span class="menu">
                <a href="http://bearty.hk" style="position:absolute;left:77%;top:83%;font-family:Adobe 繁黑體 Std B;">English</a></br>
