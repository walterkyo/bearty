<%@ Page Language="C#" Culture = "en-US" AutoEventWireup="true" CodeFile="admin_control.aspx.cs" Inherits="admin_control" ValidateRequest="true" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="wrapper" style="margin-top:10px;">
        ...
        <div class="pagebody">
	        <div class="body">
                ...
                <span class="menu">
                        <a href="share_dialogue.aspx?token=token">Post beARTY dialogue</a>
                    </span>
                    </br>
                    </br>
                    <span class="menu">
                        <a href="user_review.aspx?token=token">User info review</a>
                    </span>
        </div>
