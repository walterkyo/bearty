<%@ Page Language="C#" Culture="en-US" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="contact" %>
...
<body>
    ...
    <div class="wrapper">
	    <div class="header">
            ...
            <span class="menu">
                <a href="contact_cn.aspx" style="position:absolute;left:77.2%;top:83%;">中文</a></br>
    ...
    <div class="wrapper" style="margin-top:10px;">
        ...
        <div class="pagebody">
	        <div class="body">
				...
				You can contact us via different ways. Welcome!<br/>
                <div style="text-align:left;"> 
                <br/><a href='http://www.facebook.com/bearty.hk'><img src='img/FB.jpg' width="15%" height="15%" />http://www.facebook.com/bearty.hk</a><br/><br/>
				<a href='mailto:bearty.hk@gmail.com' ><img src='img/email.jpg' width="15%" height="15%" />bearty.hk@gmail.com </a></div>
            </div>
        </div>
		<div class="siderbar">
