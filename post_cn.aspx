<%@ Page Language="C#" Culture="en-US" AutoEventWireup="true" CodeFile="post_cn.aspx.cs" Inherits="post_cn" %>
...
<body>
    ...
    <div class="wrapper">
	    <div class="header" style="margin-top:30px;">
            ...
            <span class="menu">
                <a href="http://bearty.hk" style="position:absolute;left:77.2%;top:25%;font-family:Adobe 繁黑體 Std B;">english</a></br>
                
                <asp:LinkButton ID="logout_lnk" runat="server" visible="false" OnClick="logout_lnk_OnClick" style="position:absolute;left:97.1%;top:10%;font-family:Adobe 繁黑體 Std B;">登出</asp:LinkButton>
                <a href="advertise_cn.aspx" style="position:absolute;left:97.1%;top:25%;font-family:Adobe 繁黑體 Std B;">廣告</a>
                </br>
                <a href="about_cn.aspx" style="position:absolute;left:77.2%;top:40%;font-family:Adobe 繁黑體 Std B;">關於 beARTY</a>
                <a href="contact_cn.aspx" style="position:absolute;left:95%;top:40%;font-family:Adobe 繁黑體 Std B;">聯絡我們</a>
    ...
    <div class="wrapper">
        ...
        <div class="pagebody">
	        <div class="body">
            <span>
                <a href="post_list.aspx?category=dialogue" class ="cat_white" style="text-decoration: none;padding-left: 15px;padding-right: 15px;">beARTY Dialogue</a>
            </span>
        </br>
        </br>
        ...
        <asp:ListView ID="DialogView" runat="server" DataKeyNames="pid" 
            ...
            <ItemTemplate>
                ...
                <A HREF="postdetail_cn.aspx?pid=<%#Eval("pid") %>"><img src='<%#Eval("p_img") %>' style='max-width: 773px;min-width: 773px;'></A>
                </div>
                <div class="lb">
                <div style="float:right;"><a href="javascript:void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent('http://bearty.hk/postdetail_cn.aspx?pid=<%#Eval("pid") %>')),'sharer','top='+(screen.height-436)/2+',left='+(screen.width-626)/2+', width=626,height=436,toolbar=0,status=0,resizeable=no'));"><img src="./img/facebook.png" border="0"></a></div>
                <div style="width:650px;word-wrap:break-word;overflow: auto;font-family:Arial;"><a href="postdetail_cn.aspx?pid=<%#Eval("pid") %>" class="t_link" ><%#Eval("title") %></a></div>
                </div>
                <div class="description" style="overflow:hidden;">
                <div style="width: 710px">
                <div style="width: 710px">
                <div style="float:right;"><asp:Label ID ="time_lb" runat="server"><%#Eval("time") %></asp:Label></div>
                <div style="font-family:Adobe 繁黑體 Std B;-webkit-text-size-adjust:none;font-size:13px;padding-left:5px;">
                作者：<a href="profile_cn.aspx?user=<%#Eval("login_name") %>" class="t_link" style="text-align:left;"><%#Eval("login_name") %></a>
                </div>
                ...
                <div><asp:Label ID="catagory_lb" runat="server" Text="" style="font-family:Arial;-webkit-text-size-adjust:none;font-size:13px;padding-left:5px;"/></div>
                    <br>
                <div style="font-family:Adobe 繁黑體 Std B;font-size:small;-webkit-text-size-adjust:none;padding-left:5px;">
                <asp:Literal ID="p_content" runat="server" Mode="Encode" ></asp:Literal></div>
                </br>

                <a href="postdetail_cn.aspx?pid=<%#Eval("pid") %>" class="t_link2" style="padding-left:5px;font-family:Adobe 繁黑體 Std B;">(繼續閱讀 »)</a>
                </div>
                </br>
                <div>
                ...
                <div class="fb-like" style="position:absolute;left:82%;bottom:0%;overflow:hidden;float:left;" data-href="http://bearty.hk/postdetail_cn.aspx?pid=<%#Eval("pid") %>" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" ></div>
                <div class="bubble" onclick="location.href='postdetail_cn.aspx?pid=<%#Eval("pid")%>#comments';" style="cursor:pointer;position:absolute;left:95%;bottom:80%; float:right;"><asp:Label id="cm_counter" runat="server" style="-webkit-text-size-adjust:none;font-size:12px;font-weight:bold;"></asp:Label></div>
        ...
        <div class="post_catbar">
                ...
                <div class="post_catbar">
                    ...
                    <span style="float:right;">
                        <a href="post_list.aspx?category=event" class ="cat_white" style="text-decoration: none;padding-left: 15px;padding-right: 15px;">event</a>
                    </span>
        ...
        <asp:ListView ID="PostListView" runat="server" DataKeyNames="pid" 
            ...
            <ItemTemplate>
                <div class="bot_post">
                <div class="content" style='text-align : center;'>
                <A HREF="postdetail_cn.aspx?pid=<%#Eval("pid") %>"><img src='<%#Eval("p_img") %>' style='max-width: 308px;min-width: 308px;'></A>
                </div>
                <div class="lb">
                <div style="float:right;"><a href="javascript:void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent('http://bearty.hk/postdetail_cn.aspx?pid=<%#Eval("pid") %>')),'sharer','top='+(screen.height-436)/2+',left='+(screen.width-626)/2+', width=626,height=436,toolbar=0,status=0,resizeable=no'));"><img src="./img/facebook.png" border="0"></a></div>
                <div style="width:230px;word-wrap:break-word;overflow: auto;font-family:Arial;"><a href="postdetail_cn.aspx?pid=<%#Eval("pid") %>" class="t_link" ><%#Eval("title") %></a></div>
                </div>
                <div class="description" style="overflow:hidden;">
                ...
                <div style="position:relative;display:block;height:auto;margin-top:-20px;">
                <div class="fb-like" style="position:absolute;left:55%;bottom:0%;overflow:hidden;float:left;" data-href="http://bearty.hk/postdetail_cn.aspx?pid=<%#Eval("pid") %>" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false" ></div>
                <div class="bubble" onclick="location.href='postdetail_cn.aspx?pid=<%#Eval("pid")%>#comments';" style="cursor:pointer;position:absolute;left:85%;bottom:80%; float:right;"><asp:Label id="cm_counter" runat="server" style="-webkit-text-size-adjust:none;font-size:12px;font-weight:bold;"></asp:Label></div>
