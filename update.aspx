<%@ Page Language="C#" Culture="en-US" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="update" %>
...
<body>
    ...
    <div class="wrapper">
	    <div class="header">
            ...
            <span class="menu">
                <a href="update_cn.aspx" style="position:absolute;left:77.2%;top:83%;">中文</a></br>
...
<div class="wrapper" style="margin-top:10px;">
	...
	<div class="pagebody">
       ...
       <table width="100%">
       <tr><td width="25%">Old Password</td>
        ...
        <tr><td>Email</td><td><asp:TextBox ID="email" runat="server" ></asp:TextBox></td><td><asp:RegularExpressionValidator ID="emailform" runat="server"     
                                    ErrorMessage="This email does not validate." 
                                    ControlToValidate="email"     
                                    ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic"/></td></tr>
        <tr><td>New Password</td><td><asp:TextBox ID="pwd" runat="server" TextMode="password"></asp:TextBox></td><td><asp:Label ID="onn" runat="server"/></td></tr>
 ...
 ClientValidationFunction="ValidateFileUpload" ErrorMessage="Please select valid image file" Display="Dynamic"></asp:CustomValidator></td></tr>
        <tr><td colspan="3"><asp:Button ID="Submit_Btn" onClick="Submit_Btn_OnClick" CssClass="content_btn" runat="server" Text="Submit"/></td></tr>
