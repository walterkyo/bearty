<%@ Page Language="C#" Culture = "en-US" AutoEventWireup="true" CodeFile="share_cn.aspx.cs" Inherits="share_cn" ValidateRequest="true"%>
...
<body>
    ...
    <div class="wrapper">
	    <div class="header">
            ...
            <span class="menu">
                <a href="share.aspx" style="position:absolute;left:77%;top:83%;font-family:Adobe 繁黑體 Std B;">English</a></br>
        ...
        <div class="share_post" style="width:754px;"> 
            <div style="width:220px;float:right;">
                ...
                <asp:CheckBoxList ID="cat_CheckBox" runat="server" >
                    ...
                    <asp:ListItem>藝術</asp:ListItem>
                    <asp:ListItem>設計</asp:ListItem>
                    <asp:ListItem>電影</asp:ListItem>
                    <asp:ListItem>攝影</asp:ListItem>
                ...
                <asp:CheckBoxList ID="own_chkbox" runat="server" >
                    <asp:ListItem>你的作品</asp:ListItem> 
                </asp:CheckBoxList>
                <asp:Label ID="Label1" runat="server" width="220px" style="-webkit-text-size-adjust:none;font-size:11px;word-wrap:break-word;padding-left:20px;">- 選這個會把此作品加入你的作品集</asp:Label>
            ...
            <div class="share_lbody">
                ...
                <asp:Label ID="eventDate_lb" runat="server" Text="舉辦日期: " Visible="false"/>
                </div>
                <div style="height:30px;">
                <asp:Label ID="relb" runat="server" Text="相關活動:"/>
                </div>
            ...
            <div class="share_rbody">
                ...
                封面圖片&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="f_upload" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_btn" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" OnClick="upload_btn_OnClick" style="cursor:pointer"/>
                ...
                <asp:Label ID = "redesclb" runat="server" Font-Size="XX-Small">輸入相關活動名稱或連結</asp:Label>
                </div>
                <div style="height:250px">
            ...
            <div class="share_rbody">
                <div style="height:25px">
                圖片 1&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="other_upload1" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_other_btn1" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" CommandArgument='1' CommandName="upload_other" OnClick="upload_other_btn_OnClick" style="cursor:pointer"/>
            ...
            <div class="share_rbody">
                <div style="height:25px">
                圖片 2&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="other_upload2" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_other_btn2" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" CommandArgument='2' CommandName="upload_other" OnClick="upload_other_btn_OnClick" style="cursor:pointer"/>
            ...
            <div class="share_rbody">
                <div style="height:25px">
                圖片 3&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="other_upload3" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_other_btn3" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" CommandArgument='3' CommandName="upload_other" OnClick="upload_other_btn_OnClick" style="cursor:pointer"/>
            ...
            <div class="share_rbody">
                <div style="height:25px">
                圖片 4&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="other_upload4" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_other_btn4" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" CommandArgument='4' CommandName="upload_other" OnClick="upload_other_btn_OnClick" style="cursor:pointer"/>
            ...
            <div class="share_rbody">
                <div style="height:25px">
                圖片 5&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="other_upload5" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_other_btn5" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" CommandArgument='5' CommandName="upload_other" OnClick="upload_other_btn_OnClick" style="cursor:pointer"/>
            ...
            <div class="share_rbody">
                <div style="height:25px">
                圖片 6&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="other_upload6" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_other_btn6" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" CommandArgument='6' CommandName="upload_other" OnClick="upload_other_btn_OnClick" style="cursor:pointer"/>
            ...
            <div class="share_rbody">
                <div style="height:25px">
                圖片 7&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="other_upload7" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_other_btn7" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" CommandArgument='7' CommandName="upload_other" OnClick="upload_other_btn_OnClick" style="cursor:pointer"/>
            ...
            <div class="share_rbody">
                <div style="height:25px">
                圖片 8&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="other_upload8" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_other_btn8" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" CommandArgument='8' CommandName="upload_other" OnClick="upload_other_btn_OnClick" style="cursor:pointer"/>
            ...
            <div class="share_rbody">
                <div style="height:25px">
                圖片 9&emsp;max 4 MB (support jpg, jpeg, png)
                </div>
                <div style="height:50px">
                <asp:FileUpload id="other_upload9" type="file" width = "300px" runat="server" />
                <asp:Button ID="upload_other_btn9" runat="server" Text="上載" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" CommandArgument='9' CommandName="upload_other" OnClick="upload_other_btn_OnClick" style="cursor:pointer"/>
            ...
            <div class="share_rbody">
                ...
                <asp:Button ID="yt_btn" runat="server" Text="加入" BackColor="White" BorderStyle="None"  Width="70px" Height="30px" OnClick="yt_btn_OnClick" style="cursor:pointer"/>
                </div>
                <div style="height:30px">
            ...
            <asp:Button ID="share_btn" runat="server" Text="submit" CssClass="content_btn_cn" OnClick="share_btn_OnClick"
                onClientClick="if(!confirm('Confirm to share the post.'))return false;"/>
            <asp:Button ID="clear_btn" runat="server" Text="clear" CssClass="content_btn_cn" OnClick="clear_btn_OnClick"
                onClientClick="if(!confirm('Confirm to clear all uploaded photos and content.'))return false;"/>
            <asp:Button ID="uploadmore_btn" runat="server" Text="upload more..." CssClass="content_btn_cn" OnClick="uploadmore_btn_OnClick"/>
            </br></br>
            </div>
