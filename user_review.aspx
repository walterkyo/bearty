<%@ Page Language="C#" Culture="en-US" AutoEventWireup="true" CodeFile="user_review.aspx.cs" Inherits="user_review" %>
    ...
    <div class="wrapper" style="margin-top:10px;">
        ...
        <div class="pagebody">
	        <div class="body">
                ...
                <span>
            User name: <asp:Textbox runat="server" ID="user_serach" CssClass="search_bar" style="background:transparent;"/>
            <asp:ImageButton ID="search_user_btn" ImageUrl="./img/search_btn.gif" OnClick="search_user_btn_OnClick" runat="server" onmouseover="this.src='./img/search_btn_hover.gif'" onmouseout="this.src='./img/search_btn.gif'"/>
            </span>

                </br></br>
        <asp:ListView ID="PostListView" runat="server" DataKeyNames="uid" 
            DataSourceID="SqlDataSource1" OnItemDataBound="PostListView_OnItemDataBound">
            <EmptyDataTemplate>
                <br>
                </br>
                <br></br>
                <span>No related user.</span>
                <br>
                </br>
                <br></br>
            </EmptyDataTemplate>
            ...
            <ItemTemplate>
                ...
                <div class="lb">
                <div style="width:650px;word-wrap:break-word;overflow: auto;font-family:Arial;"><a href="#" class="t_link" ><%#Eval("login_name") %></a></div>
                </div>
                <div class="description" style="overflow:hidden;">
                <div style="width: 710px">
                <div style="width: 710px">
                <div style="font-family:Arial;-webkit-text-size-adjust:none;font-size:13px;padding-left:5px;">
                user account: <%#Eval("login_name") %>
                </div>
                <div style="font-family:Arial;-webkit-text-size-adjust:none;font-size:13px;padding-left:5px;">
                user name: <%#Eval("nickname") %>
                </div>
                <div style="font-family:Arial;-webkit-text-size-adjust:none;font-size:13px;padding-left:5px;">
                e-mail: <%#Eval("email") %>
                </div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM ba_user;"></asp:SqlDataSource>
        </div>
