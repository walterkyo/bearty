<%@ Page Language="C#" Culture="en-US" AutoEventWireup="true" CodeFile="advertise.aspx.cs" Inherits="advertise" %>
...
<body>
    ...
    <div class="wrapper">
	    <div class="header">
            ...
            <span class="menu">
                <a href="advertise_cn.aspx" style="position:absolute;left:77.2%;top:83%;">中文</a></br>
    ...
    <div class="wrapper" style="margin-top:10px;">
        ...
        <div class="pagebody">
            ...
            <div style="width:780px;word-wrap:break-word;">
                <asp:Label runat="server" ID="ad_lb" Width="780px">BeARTY is a non-profitable website. We need different resources for our operation and further development. We welcome all forms of sponsorship or advertising on beARTY, please contact us for details.</asp:Label>
            </div>
            </br>
            <div>
