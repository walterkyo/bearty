...
public partial class profile : System.Web.UI.Page
{
    ...
    protected void sort_btn_OnClick(object sender, EventArgs e)
    {
        ...
        SqlDataSource1.SelectCommand = "SELECT * FROM [ba_post] where [status] = 'approved' and [p_type] like '%" + sort_btn.Text + "%' order by [time] desc;";
    }
    ...
    {
        SqlDataSource1.SelectCommand = "SELECT * FROM [ba_post] where [status] = 'approved' and ([title] like N'%" + search_bar.Text + "%' or [login_name] = N'" + search_bar.Text + "') order by [time] desc;";
    }
