<%@ Page Language="C#" Culture="en-US" AutoEventWireup="true" CodeFile="registered.aspx.cs" Inherits="registered" %>
...
<body>
    ...
    <div class="wrapper" style="margin-top:10px;">
        ...
        <div class="post"> 
            <div>
                <font style="font-family:Arial;-webkit-text-size-adjust:none;font-size:13px;">You registered as </font>
                <asp:Label runat="server" ID="txtUserName" ForeColor="Red"></asp:Label> <font style="font-family:Arial;-webkit-text-size-adjust:none;font-size:13px;"> of beARTY.</fon><br /><br />
                <a href="http://bearty.hk"><font style="font-family:Arial;-webkit-text-size-adjust:none;font-size:13px;">Return to home page.</font></a>
                <br />
